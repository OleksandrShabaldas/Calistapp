...
private fun AuditRow(
    ...
    Row(
        ...
        Text(
            ...
            color = accent ?: if (strong) Cream else CreamMuted,
        )
    }
}
...
private fun Note(text: String) {
    Text(text, style = MaterialTheme.typography.labelSmall, color = CreamMuted.copy(alpha = 0.85f))
}
...
private fun CalorieAudit.Basis.accent(): Color = when (this) {
    CalorieAudit.Basis.HEART_RATE -> Emerald
    CalorieAudit.Basis.REP_WORK -> Amber
    CalorieAudit.Basis.RESTING_FLOOR -> CreamMuted
